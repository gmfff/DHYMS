...
public class SystemHrController {
    ...
    public RespBean hrReg(String username, String password,String phone,String name,String address,String telephone,String userface){
        System.out.println("11111111111"+phone);
        int i = hrService.hrReg(username,password,phone,name,address,telephone,userface);
