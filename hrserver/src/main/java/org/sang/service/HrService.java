...
public class HrService implements UserDetailsService {
    ...
    public int hrReg(String username, String password,String phone,String name,String address,String telephone,String userface) {
        //如果用户名存在，返回错误
        ...
        return hrMapper.hrReg(username,encode,phone,name,address,telephone,userface);
    }
